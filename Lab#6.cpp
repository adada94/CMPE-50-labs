...
//
///* CODE OUTPUT
//* file has been outputted to a file called Output.txt
// *Executing Exercise 1
// The status for the private variable for status in the first resource object is currently: 0
// The status for the private variable for status in the second resource object is currently: 0
// Now we will set the new value of the two resource instances:
// res1:  Set to 0 or 1
// 0
// res2:  Set to 0 or 1
// 1
// Resource Unavailable
// The current result of the first resource value  status: 0
// The current result of the second resource values  status: 1
